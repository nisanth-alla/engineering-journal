...
import rollingImg from "../../../../public/images/infrastructure/rolling-deployment.png";
import { Image } from "astro:assets";

<Image
  src={rollingImg}
  alt="Rolling deployment shown as four rows of four boxes. Row 1: all boxes labeled old. Row 2: first box labeled new, rest old. Row 3: first two new, rest old. Row 4: all new. A vertical arrow on the left labeled time points downward."
