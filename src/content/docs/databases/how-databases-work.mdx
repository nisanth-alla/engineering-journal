...
import heapImg from "../../../../public/images/databases/heap-pages.png";
import { Image } from "astro:assets";

<Image
  src={heapImg}
  alt="Database heap file: a vertical stack of five pages (Page 1 through Page 5), each subdivided into rows of different widths. One row has a dashed border labeled the row you want. An arrow from outside labeled Full table scan: reads all 5 pages points at the whole stack. Another arrow labeled Index: reads 1 page points directly to the highlighted row."
