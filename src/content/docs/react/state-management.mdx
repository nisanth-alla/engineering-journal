...
This distinction changed how I think about state management. Most of the "state" in a typical web app isn't really _your_ state. It's a cached copy of server data.
